/* MENU PARA MANEJAR  UN CURSOR AVL EN DISCO DURO
   ESTE PROGRAMA EJECUTA  EL CODIGO CAP71A.C */
...
#include "stdio.h"
#include "conio.h"
#include "c:\borlandc\bin\becerra\estruc~1\cap71a.c"
int uno(),dos(),tres();
int uno1(),dos1(),tres1();
int cuatro (),cinco();
int *tareas1 [] = {
...
main()
{
	...
	menuprincipal (op1,10,10,70,20,3,8,
		"MENU PRINCIPAL ARBOLES AVL",6,15,3,tareas1);
}
